...
const HeaderCartButton = (props) => {
    ...
    return (
        <button className={btnClasses} onClick={props.onClick}>
            ...
            <span className="text-sm md:text-base bg-orange-500 py-0.5 md:py-1 px-2 md:px-4 rounded-3xl ml-4 font-bold group-hover:bg-yellow-850 group-focus:bg-yellow-850">
                {numberOfCartItems}
            </span>
        </button>
    );
